...
<div class="relative shrink-0" data-admin-notifications>
  <button type="button" data-notification-open aria-controls="okv-notification-panel"
    ...
    <span data-notification-badge
          class="absolute right-0 top-0 inline-flex min-h-5 min-w-5 items-center justify-center rounded-full bg-tomato px-1 font-mono text-okv-caption font-semibold leading-none text-white <?= $okv_notification_count < 1 ? 'hidden' : '' ?>"><?= okv_e($okv_notification_badge) ?></span>
  </button>
