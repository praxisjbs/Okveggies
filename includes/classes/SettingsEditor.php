...
final class SettingsEditor
{
    ...
    public static function sampleTokens(string $templateKey): array
    {
        ...
        $all = [
            ...
            'reason'          => 'Weekly market buying for five restaurants. We need steady supply without paying cash on each delivery.',
        ...
        if ($templateKey === 'admin_new_credit_application' && isset($sample['admin_url'])) {
