...
/**
 * shop.php
 * OK Veggies. Browse produce by category, with search and filters.
...
<div class="okv-container py-16">
  ...
  <h1 class="font-display font-extrabold text-3xl text-ink mt-2">Shop</h1>
