...
6. **Smoke test and lint.** `php -l` every file you touched. Run `bash scripts/verify.sh` and the relevant role smoke test. Load the page on a narrow (mobile) and wide (desktop) viewport.
