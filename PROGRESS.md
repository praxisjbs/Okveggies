...
- Pending: the photograph file itself did not land in the workspace when it was attached, so it is not committed yet. Drop it at `assets/img/brand/founder-kumbish-emmanuel-putleh.jpg` (resized to 1080px max at quality 82) and the page picks it up automatically: no further code change. Until it is present the page serves byte for byte what it serves today.
