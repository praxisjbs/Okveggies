...
- Battery re-run on the merged tree (evidence `docs/evidence/720625b47f/15-audit-round-766c0df-72f59b8.log`): unit 3,426/3,426 GREEN, `php -l` 321/321, node guards 52 + 128 + 98, brand green, guard matrix 8/8, both gate preflight refusals exit 2 naming the reason, floor refuses empty output, `mysqld` still absent so the MySQL-8 and browser sections stay NOT RUN everywhere.
