...
/**
 * product.php
 * OK Veggies. A product page with gallery, price, description and pairings.
...
<title>Product . OK Veggies</title>
...
<div class="okv-container py-16">
  ...
  <h1 class="font-display font-extrabold text-3xl text-ink mt-2">Product</h1>
  <p class="text-ink-60 mt-3 max-w-xl">This screen is scaffolded and waiting to be built in milestone M2. The plan for it is in docs/PRD.md Section 5.</p>
