...
/**
 * admin/pricing.php
 * OK Veggies. Weekly prices, inline and by spreadsheet.
 * Status: scaffold placeholder. Build in milestone M2. See docs/PRD.md Section 6.
...
<title>Pricing . OK Veggies</title>
...
<div class="okv-container py-16">
  ...
  <h1 class="font-display font-extrabold text-3xl text-ink mt-2">Pricing</h1>
  <p class="text-ink-60 mt-3 max-w-xl">This screen is scaffolded and waiting to be built in milestone M2. The plan for it is in docs/PRD.md Section 6.</p>
