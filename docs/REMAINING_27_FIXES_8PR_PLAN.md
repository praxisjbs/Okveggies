...
| PR8 | Motion System - Make It Move | 30 | [x] Done `403fb8a` PR #61 open, not for merge yet. One owner `okv-motion.js` (396 lines) with self-hosted GSAP 3.12.5 SRI-pinned, all contracts implemented; motion suite 56/56 at 390 and 1440 with video (three green runs), brand 8/8, builds green, axe 0 critical on the motion fixture, CLS 0.0000, full motion under reduced motion; site homepage/visual/axe suites and Lighthouse registered for CI on the PHP stand | 100% | 95% | 95% | `403fb8a` | 20 Sep 2026 |
