...
okv_test_ok(str_contains($page, 'Upload') && str_contains($page, 'deferred'), 'photography is read-only until the later media task');
...
foreach (['updateDraft', 'publish', 'unpublish'] as $method) {
