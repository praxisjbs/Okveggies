...
/**
 * page.php
 * OK Veggies. An editable content page (About, How It Works, FAQ, legal).
 * Status: scaffold placeholder. Build in milestone M12. See docs/PRD.md Section 18.
...
<div class="okv-container py-16">
  ...
  <h1 class="font-display font-extrabold text-3xl text-ink mt-2">Page</h1>
